      ...
      <div className="homebody">
        ...
        <div className="main">
          ...
          <div className="linebtn">
            ...
            <button type="submit" className="tabbtn" id="tabbtn">
              <NavLink className="link" to="/Reserve">
                Book a Table
              </NavLink>
            </button>
          </div>
        ...
        <div id="stodiv">
          <div className="sto">
            ...
            <p>
              ...
              <br />
              through a diverse tapestryof tastes and textures.
            </p>
          </div>
          <div className="fimg">
          ...
          <div className="contact">
            ...
            <div className="contcard">
              ...
              <div className="time">
                ...
                <p className="time1">
                  Friday, Saturday and Sunday: Booking
                  <br />
                  from 12pm - 1.30pm
                </p>
                <p>
                ...
                <p>Daily: Booking from 6pm - 11.30pm</p>
              </div>
            </div>
          </div>
          <Footer />
